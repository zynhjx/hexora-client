...
const FIRE_GRADIENT_ID = "fireGradient";

const FireIconFilled = ({ className = '', style = {}, width = 24, height = 24, ...props }) => (
  <svg
    className={className}
    style={style}
    width={width}
  ...
  >
    <defs>
      <linearGradient id={FIRE_GRADIENT_ID} x1="6" y1="6" x2="18" y2="22" gradientUnits="userSpaceOnUse">
        <stop stopColor="#ffda7b" />
